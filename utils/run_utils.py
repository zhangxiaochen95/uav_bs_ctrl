from utils.user_config import DEFAULT_DATA_DIR, FORCE_DATESTAMP, DEFAULT_SHORTHAND, WAIT_BEFORE_LAUNCH
...
def call_experiment(exp_name, thunk, seed=0, num_cpu=1, data_dir=None, 
    ...
    print(f"Results are saved to {logger_kwargs['output_dir']}.")
...
class ExperimentGrid:
    ...
    def add(self, key: object, vals: object, shorthand: object = None, in_name: object = False) -> object:
        """
