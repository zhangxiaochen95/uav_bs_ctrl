...
if __name__ == '__main__':
    ...
    eg.add('env_kwargs:map_id', ['4ubs', '6ubs', '8ubs'], '', True)
    ...
    eg.add('train_kwargs:o', 'gnn', '', True)
    ...
    eg.add('train_kwargs:steps_per_epoch', 30000)
    eg.add('train_kwargs:update_after', 20000)
    eg.add('train_kwargs:save_freq', 10)
